  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden" style={{ backgroundColor: "#ffd139" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Layout: Left vertical nav + right tabbed content */}
        <div className="mt-4 grid grid-cols-1 lg:grid-cols-[220px_minmax(0,1fr)] gap-6">
          {/* Left Sidebar (visible on lg+) */}
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-2">
              <Button
                variant={tab === "overview" ? "default" : "ghost"}
                className={`w-full justify-start border-2 border-black ${tab === "overview" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
              ...
              <Button
                ...
                className={`w-full justify-start border-2 border-black ${tab === "lessons" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
              ...
              <Button
                ...
                className={`w-full justify-start border-2 border-black ${tab === "quizzes" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
              ...
              <Button
                ...
                className={`w-full justify-start border-2 border-black ${tab === "challenges" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
              ...
              <Button
                ...
                className={`w-full justify-start border-2 border-black ${tab === "leaderboard" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
              ...
              <Button
                ...
                className={`w-full justify-start border-2 border-black ${tab === "rewards" ? "bg-black text-white" : "bg-white text-black hover:bg-white/90"}`}
